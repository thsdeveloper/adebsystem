        ...
        try {
            ...
            if ($validator->passes()) {
                ...
                if ($user->save()) {
                    ...
                    $user_detail->data_conversao = ($request->data_conversao !== null ? Carbon::createFromFormat('d/m/Y', $request->data_conversao) : null);
                    $user_detail->data_batismo = ($request->data_batismo !== null ? Carbon::createFromFormat('d/m/Y', $request->data_batismo) : null);

  ...
  <v-form ref="form" v-model="valid">
    <v-card>
      ...
      <v-card-text class="mt-5">
        ...
        <v-row>
          <v-col>
            <v-btn outlined color="indigo" href="/img/POLITICA_DE_PRIVACIDADE_ADEB.pdf" target="_blank">Ler políticas de privacidade</v-btn>
            <v-checkbox :rules="rules.campoObrigatorio" v-model="form.politicas" label="Aceito as políticas de privacidade."></v-checkbox>
          </v-col>
        </v-row>
